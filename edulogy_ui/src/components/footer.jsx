  ...
  return (
    ...
    >
      ...
      <div className="footer__link footer-test-link">
        ...
        <a href="/kiem-tra/part-VI" className="link">
          <i className="fas fa-angle-double-right"></i>Part VI: Hoàn thành đoạn văn
        </a>
        <a href="/kiem-tra/part-VII" className="link">
          <i className="fas fa-angle-double-right"></i>Part VII: Đọc hiểu
        </a>
      </div>
